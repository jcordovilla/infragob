---
layout: post
title: "PPPs en Crisis (3). El modelo vigente"
date: 2019-05-02
slug: ppps-en-crisis-3
excerpt: "El modelo convencional de PPP es el resultado de la evolución de las políticas de infraestructuras y desarrollo de determinados países."
...
- El contrato o los contratos se articulan de forma que cada riesgo se asigna a la parte más capacitada para gestionarlo (principio de la eficiencia en el reparto de riesgo). De este principio se desprende la práctica de que el socio privado aporte recursos financieros que el socio público no puede aportar, además de experiencia e incentivos para la construcción y operación eficiente de la infraestructura.
- El socio privado financia, construye y explota la infraestructura a cambio de un derecho de cobro, que vendrá del usuario del servicio, del socio público o de ambos. Se suele realizar mediante el establecimiento de "sociedades vehículo" que asumen los derechos y obligaciones contractuales.
- Una parte mayoritaria se financia mediante deuda (se conocen como inversiones "apalancadas", lo que convierte al contrato de crédito en un elemento fundamental y determinante de la PPP.
