---
layout: post
title: "El plan es...que no hay Plan"
date: 2019-07-10
slug: el-plan-es-que-no-hay-plan
...
Hay determinadas ideas y aspiraciones, como las que se describen en las [Líneas Generales para la Legislatura](https://www.fomento.gob.es/recursos_mfom/20180712politicaministeriofomentolegislaturalinea.pdf) de 2018, por cierto sorprendentemente similares a las del [programa electoral del PSOE de este año 2019.](https://www.psoe.es/media-content/2019/04/PSOE-programa-elecciones-generales-28-de-abril-1-15-42.pdf) Hay estrategias, y un documento llamado Plan de Infraestructuras del Transporte y Vivienda ([PITVI 2012-2014](https://www.fomento.gob.es/el-ministerio/planes-estrategicos/2024/pitvi-2012/2024/plan-de-infraestructuras-transporte-y-vivienda-pitvi-2012/plan-de-infraestructuras-transporte-y-vivienda-pitvi-2012-2024)) que ha quedado abandonado *de facto* y que nunca fue un verdadero Plan, en mayúsculas. ¿Por qué digo esto? Porque un verdadero Plan de infraestructuras debe tener:

- Un diagnóstico amplio y riguroso de la situación actual que responda a la pregunta ¿qué infraestructuras tenemos, y cuáles hacen falta?
- Una visión a largo plazo: ¿dónde queremos llegar con la inversión en infraestructuras?
- Un listado de actuaciones con su desarrollo en el tiempo: ¿exactamente qué inversiones hay que realizar y cuándo se van a llevar a cabo?
- Un plan detallado de viabilidad económico-financiera: ¿cómo se van a pagar esas infraestructuras?
- Un marco de trabajo bien definido -legal, institucional, técnico, de colaboración con el ciudadano y el sector privado: ¿con qué recursos y herramientas contamos y cuáles necesitamos para llevar a cabo el plan?
...
No estamos solos. España, como le ocurre a muchos países, no conoce con precisión el stock real de infraestructuras que tiene. Tenemos aproximaciones, como la [base de datos de inversión pública](https://www.imf.org/external/np/fad/publicinvestment/) del Fondo Monetario Internacional, pero no tenemos un catálogo actualizado y homogéneo de las infraestructuras con las que cuenta el país, el estado en el que están y el nivel de servicio o funcionalidad que tienen, es decir en qué medida cumplen su función y repercuten positivamente en nuestras vidas.
...
- No hay referencia alguna al grado de cumplimiento del PITVI.
